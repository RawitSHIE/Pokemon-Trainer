...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2017 at 06:46 AM
...
CREATE TABLE `pokemon` (
  ...
  `sp_atk` varchar(6) DEFAULT NULL,
  `sp_def` varchar(6) DEFAULT NULL,
...
INSERT INTO `pokemon` (`no`, `id`, `name`, `type_1`, `type_2`, `total`, `hp`, `attack`, `defense`, `sp_atk`, `sp_def`, `speed`, `generation`, `legendary`) VALUES
...
(738, '669', 'Flabébé', 'Fairy', '', '303', '44', '38', '39', '61', '79', '42', '6', 'FALSE'),
...
--
ALTER TABLE `pokemon`
  MODIFY `no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=801;
COMMIT;
